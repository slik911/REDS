        ...
        <div class="col-md-8">
            <div class="row">
                ...
                <div class="mb-3 col-md-8">
                    ...
                    <input type="text" class="form-control col-md-8" id="email" name="email" value="{{$staff->email ? $staff->email : old('email') }}" placeholder="Enter Email">
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <select name="role" id="role" class="form-select" aria-label="Default select example">
                        ...
                        @foreach ($roles as $role)
                            <option value="{{$role->id}}"  {{ $staff->role->id == $role->id ? 'selected' : '' }} style="text-transform: capitalize">{{$role->name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
