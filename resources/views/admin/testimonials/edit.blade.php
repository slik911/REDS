...
@section('content')
   <form action="{{route('admin.testimonial.update')}}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <input type="hidden" name="uuid" value="{{$testimonial->uuid}}">
    <div class="row">
            ...
            <div class="mb-3 col-md-6">
                ...
                <select name="client_id" id="client_id" class="form-select">
                    ...
                    <option value="{{ $client->uuid }}" {{ $client->uuid == $testimonial->client_id ? 'selected' : '' }}>
    ...
    <div class="row">
        <div class="mb-3 col-md-6">
            ...
            <textarea name="message" id="message" class="form-control" cols="30" rows="10" oninput="limitWords(this, 30)" onkeydown="limitWords(this, 30, event)">{{$testimonial->message}}
            </textarea>
