        ...
        <div class="carousel-item active c-item">
            ...
            <div class="carousel-caption cbanner-caption">
                ...
                <nav class="breadcrumb-nav" aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('rental')}}" class="text-white">Rental</a></li>
                    <li class="breadcrumb-item active text-white" aria-current="page">{{$rental->title}}</li>
                    </ol>
                </nav>
            </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 p-2">
          ...
          <p style="font-size:17px" class="mt-3">
            <b>Price:</b><span> CAD {{number_format($rental->rental->price)}}</span>
          </p>
          ...
          <section>
            ...
            <table class="table table-bordered"  style="width:100%">
              @foreach (json_decode($rental->rental->meta_data) as $key => $value)
                  <tr>
                    <th>
                        <img src="{{asset('icons/'.$key.'.png')}}" class="img-fluid " alt="" style="width:30px; height:30px; margin-right:10px"> {{$key}}
                    </th>
                    <td>
                      {{$value}}
                    </td>
